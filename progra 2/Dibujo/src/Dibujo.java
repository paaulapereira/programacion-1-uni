...
public class Dibujo extends Frame {
   ...
   class Lienzo extends Panel{
      ...
      public void dibuja(int x1,int y1,int x2,int y2) {  
    	  ...
    	  if(tf!=null & r!=null & c!=null){    		  
    		  ...
    		  }else if(c.equals("Rosado")){
    			//añade el color rosado
    				color=new Color(214,5,147);  
    		  }else if(c.equals("Amarillo")){
      			//añade el color amarillo
  				color=new Color(249,255,50);  
    		  }else if(c.equals("Morado")){
        			//añade el color morado
    				color=new Color(184,96,249);  
      		  }else {
    				  color=new Color(0,0,255);
    		  
    		  }if(tf.equals("Rectangulo")) {
    			  figs.add(new Rectangulo(x1,y1,x2,y2,color,r.equals("si")));
    		  }else if(tf.equals("Elipse")){
    			  figs.add(new Elipse(x1,y1,x2,y2,color,r.equals("si")));      		 
    		  }else if(tf.equals("Triangle")){
    			  figs.add(new Triangle(x1,y1,x2,y2,color,r.equals("si"))); //para crear el dibujo del triangulo
    		  }else if(tf.equals("Boomerang")){
    			  figs.add(new Boomerang(x1,y1,x2,y2,color,r.equals("si"))); //para crear el dibujo del triangulo
    		  }else if(tf.equals("Heart")){
    			  figs.add(new Heart(x1,y1,x2,y2,color,r.equals("si"))); //para crear el dibujo del triangulo
    		  }else{
    			  figs.add(new Diamond(x1,y1,x2,y2,color,r.equals("si")));
    		  }
   ...
   //Creacion del lienzo y de los paneles con los componentes
      ...
      //añade nuevas figuras a la lista de dibujar
      listaFiguras.add("Triangle");
      listaFiguras.add("Diamond");
      listaFiguras.add("Boomerang");
      listaFiguras.add("Heart");
    ...
    //añade nuevos colores para la lista de dibujar
